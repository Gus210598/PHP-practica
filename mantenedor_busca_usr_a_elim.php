      ...
      <div class="col-md-4">
        <form class='cajaFormularioMantenedores' enctype="multipart/form-data" action='' method='post'>
          ...
          <div class="contenedor2">
            <button name='borraUsuario' id='' type='submit' class='alinear-boton btn btn-success'>Aceptar</button>
...
<?php
  if(isset($_POST['borraUsuario'])){
    ...
    if ($usuario==$_SESSION['usuario']){
      ...
      Swal.fire({
        type: 'error',
        title: 'El adiministrador a borrar es el mismo que esta en uso!!!',
      ...
      // header("Location:mantenedor_elimina_usr.php?user=$usuario");
      echo "<script>
              window.location='mantenedor_elimina_usr.php?user=$usuario';
            </script>";
    }else{
      echo "<script>
      Swal.fire({
