...
<body>
  ...
  <!-- -->
  <div class="container">
    <nav class="navbar navbar-expand-sm navbar-dark " style="background-color: rgba(100, 150, 100, 0.3);">
      ...
      <span class="navbar-text d-flex" style="color: black; font-style: italic";><?php echo $_SESSION['nombres']?></span>
    </nav>
  </div>
...
<footer class="bg-light text-center text-lg-start fixed-bottom">
  ...
  <div class="text-center p-1" style="background-color: rgba(0, 150, 100, 0.2);">
    Apoyo estadistico v.4.1 - © Agosto 27 de 2024
    <p class="text-dark">Gustavo Barahona Ilabaca</p>
  </div>
</footer>
